  ...
  const list = [
    {
      ...
      description:
        "Portable speaker with crystal clear sound and 20-hour battery life.",
      price: 89.99,
      rating: 2,
      reviewCount: 567,
      imageUrl:
    ...
    },
    {
      ...
      name: "Laptop Stand",
      description:
        "Ergonomic aluminum laptop stand for better posture and comfort.",
      price: 45.99,
      originalPrice: 59.99,
      rating: 4.5,
      reviewCount: 234,
    ...
    },
    {
      ...
      reviewCount: 445,
      imageUrl:
        "https://images.pexels.com/photos/2148222/pexels-photo-2148222.jpeg?auto=compress&cs=tinysrgb&w=500",
      isNew: true,
    },
    {
      id: "7",
      name: "Phone Case",
      description:
        "Premium protective case with military-grade drop protection.",
      price: 24.99,
      rating: 3,
      reviewCount: 1123,
      imageUrl:
